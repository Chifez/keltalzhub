  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="w-[80%] h-full rounded-lg overflow-hidden">
        ...
        <div className="flex-1 py-5 w-full h-full text-white bg-red-500 text-center text-2xl">
          <p>{courseInfo?.title}</p>
        </div>
      </div>
      ...
      <div className="w-[80%]">
        ...
        <ul className="list-disc">
          <li className="text-xl">
            ...
            individuals engaged in or aspiring to work in the video industry, or
            Adobe users desiring to expand their expertise in video
            enhancements.{' '}
          </li>
          <li className="text-xl">
            This class is suitable for novice users of After Effects or
